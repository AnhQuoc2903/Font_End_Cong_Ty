...
const HistoryModal: React.FC<Props> = ({
  ...
  const stats = React.useMemo(() => {
    ...
    const totalQuantityChange = history.reduce((sum, h) => sum + h.quantityChange, 0);
    ...
    },
    {
      ...
      render: (value: number) => (
        <div style={{
          ...
          {value > 0 ? (
            <>
              <ArrowUpOutlined style={{ color: COLORS.success, fontSize: "14px" }} />
              <Text strong style={{ 
                color: COLORS.success,
                fontSize: "16px",
                fontWeight: 700 
            ...
            <>
              <ArrowDownOutlined style={{ color: COLORS.accent, fontSize: "14px" }} />
              <Text strong style={{ 
                color: COLORS.accent,
                fontSize: "16px",
                fontWeight: 700 
        ...
        return (
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <CalendarOutlined style={{ color: COLORS.primary, fontSize: "12px" }} />
          ...
          <div style={{ flex: 1 }}>
            ...
            {artifactName && (
              <Text style={{ 
                ...
                Hiện vật: <span style={{ fontWeight: 600 }}>{artifactName}</span>
              </Text>
            )}
          </div>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <div style={{
                  ...
                  <DownloadOutlined style={{ fontSize: 20, color: COLORS.success }} />
                </div>
              </div>
            </Card>
          </Col>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <div style={{
                  ...
                  <UploadOutlined style={{ fontSize: 20, color: COLORS.accent }} />
                </div>
              </div>
            </Card>
          </Col>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <div style={{
                  ...
                  <SyncOutlined style={{ fontSize: 20, color: COLORS.warning }} />
                </div>
              </div>
            </Card>
          </Col>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div>
                  ...
                  <div style={{ 
                    fontSize: 24, 
                    fontWeight: 700, 
                    color: stats.totalQuantityChange >= 0 ? COLORS.success : COLORS.accent 
                  }}>
                    {stats.totalQuantityChange >= 0 ? '+' : ''}{stats.totalQuantityChange}
                  </div>
                </div>
                <div style={{
                  width: 40,
                  height: 40,
                  borderRadius: "50%",
                  background: stats.totalQuantityChange >= 0 
                    ? "rgba(39, 174, 96, 0.1)" 
                    : "rgba(231, 76, 60, 0.1)",
                  display: "flex",
                  alignItems: "center",
                  ...
                  {stats.totalQuantityChange >= 0 ? (
                    <ArrowUpOutlined style={{ fontSize: 20, color: COLORS.success }} />
                  ) : (
                    <ArrowDownOutlined style={{ fontSize: 20, color: COLORS.accent }} />
                  )}
                </div>
              </div>
            </Card>
              ...
              emptyText: (
                <div style={{ padding: 48, textAlign: "center" }}>
                  <div style={{
                    ...
                    <HistoryOutlined style={{ fontSize: 32, color: COLORS.textSecondary }} />
                  </div>
                  <Text style={{ color: COLORS.textSecondary, fontSize: 14 }}>
                    Chưa có giao dịch nào được ghi nhận
                  </Text>
                  <Text type="secondary" style={{ display: "block", marginTop: 8, fontSize: 12 }}>
                    Sử dụng tính năng Nhập kho, Xuất kho hoặc Điều chỉnh để tạo giao dịch
                  </Text>
                </div>
              ),
            }}
